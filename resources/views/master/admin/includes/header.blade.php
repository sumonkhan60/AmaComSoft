...
<head>
    ...
    <title>AmaComSoft - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard')}}">
                ...
                <div class="sidebar-brand-text mx-3">AmaComSoft</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseServices" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('service.add')}}">Add Service</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMarketing" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('marketing.add')}}">Add Marketing</a>
                        <a class="collapse-item" href="{{route('marketing.manage')}}">Manage Marketing</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseSite" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="">Add SiteSetting</a>
                        <a class="collapse-item" href="">Manage SiteSetting</a>
                    </div>
                </div>
            </li>
