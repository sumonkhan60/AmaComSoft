...
@section('body')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add Marketing</h1>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('marketing.new')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="submit" class="btn btn-success" name="btn" value="Create New Marketing"/>
                            </div>
                        </div>
                    </form>
                </div>
