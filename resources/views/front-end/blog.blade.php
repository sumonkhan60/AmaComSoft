        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="{{asset($recentBlog->image)}}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="{{route('blog.detail', ['id' => $recentBlog->id])}}">{{$recentBlog->title}}</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="#">John Doe</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="#">{{ \Carbon\Carbon::parse($recentBlog->created_at)->format('d/m/Y H:i:s')}}</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="">12 Comments</a></li>
                </ul>
              </div>

              <div class="entry-content">
                <p>{{$recentBlog->content}}</p>
                <div class="read-more">
                  <a href="{{route('blog.detail', ['id' => $recentBlog->id])}}">Read More</a>
                </div>
              </div>
